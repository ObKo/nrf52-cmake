...
const PALConfig pal_default_config =
{
  .pads = {
        ...
        PAL_MODE_INPUT_PULLUP,        /* P0.4                  */
        PAL_MODE_UNCONNECTED,         /* P0.5 : UART_RTS       */
        PAL_MODE_UNCONNECTED,         /* P0.6 : UART_TX        */
        ...
        PAL_MODE_UNCONNECTED,         /* P0.13: BTN1           */
        PAL_MODE_UNCONNECTED,         /* P0.14: BTN2           */
        PAL_MODE_UNCONNECTED,         /* P0.15: BTN3           */
        PAL_MODE_UNCONNECTED,         /* P0.16: BTN4           */
        PAL_MODE_UNCONNECTED,         /* P0.17: LED1           */
        PAL_MODE_UNCONNECTED,         /* P0.18: LED2           */
        PAL_MODE_UNCONNECTED,         /* P0.19: LED3           */
        PAL_MODE_UNCONNECTED,         /* P0.20: LED4           */
        PAL_MODE_UNCONNECTED,         /* P0.21                 */
        PAL_MODE_UNCONNECTED,         /* P0.22: SPI_SS         */
        PAL_MODE_UNCONNECTED,         /* P0.23: SPI_MISO       */
        PAL_MODE_UNCONNECTED,         /* P0.24: SPI_MOSI       */
        PAL_MODE_UNCONNECTED,         /* P0.25: SPI_SCK        */
        PAL_MODE_UNCONNECTED,         /* P0.26: SDA            */
        PAL_MODE_UNCONNECTED,         /* P0.27: SCL            */
        PAL_MODE_UNCONNECTED,         /* P0.28                 */
        PAL_MODE_UNCONNECTED,         /* P0.29                 */
        PAL_MODE_OUTPUT_PUSHPULL,     /* P0.30                 */
        PAL_MODE_OUTPUT_PUSHPULL,     /* P0.31                 */
  },
};
#endif
